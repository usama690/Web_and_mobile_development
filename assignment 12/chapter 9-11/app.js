// question no 1
var city = prompt("Enter your favourite city name").toLowerCase();
if (city === "karachi") {
...
// question no 3
color_input = prompt("Enter the traffic signal color name ").toLowerCase();
var color = "Red";
var color2 = "Yellow";
var color3 = "Green ";

document.write(
  "<br>" + "Signal Color : " + ".............................. Message"
);

if (color_input === "red") {
  document.write(
    "<br>" + "<br>" + color + " ......................................Must Stop"
  );
